...
class ConfigManager:
    ...
    def __init__(self, config_dir: str = None):
        ...
        # Set default config directory - environment agnostic
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "anonymity": {
                ...
                "privoxy": {
                    "listen_port": 8119,
                    "config_file": "/opt/homebrew/etc/privoxy/config",  # Keep system path for now
                    "log_file": "/opt/homebrew/var/log/privoxy/logfile",  # Keep system path for now
    ...
    def validate_config(self) -> Dict[str, List[str]]:
        ...
        # Check binary paths (treat as warnings since they may need compilation)
        binary_paths = [
        ...
        for binary_path in binary_paths:
            if binary_path:
                if not os.path.exists(binary_path):
                    ...
                    issues["warnings"].append(f"Binary not executable: {binary_path}")
